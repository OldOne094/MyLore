...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::reading_group::reading_group_prefs_get,
            commands::reading_group::reading_group_prefs_set,
            commands::reading_group::reading_group_list,
            commands::reading_group::reading_group_create,
            commands::reading_group::reading_group_rename,
            commands::reading_group::reading_group_delete,
            commands::reading_group::reading_group_view,
            commands::reading_group::reading_group_add_member,
            commands::reading_group::reading_group_remove_member,
            commands::reading_group::reading_group_shelf,
            commands::reading_group::reading_group_set_shelf,
            commands::reading_group::reading_group_notes,
            commands::reading_group::reading_group_add_note,
            commands::reading_group::reading_group_update_note,
            ...
            commands::reading_group_p2p::reading_group_note_edit,
            commands::reading_group_p2p::reading_group_note_sync,
            commands::reading_group_p2p::reading_group_relays_get,
            commands::reading_group_p2p::reading_group_relays_set,
            commands::reading_group_p2p::reading_group_sync_now,
