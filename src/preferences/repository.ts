...
import { DEFAULT_PREFERENCES, isAccentChoice, isUiDensity, type Preferences } from "./types";
...
export function parsePreferences(value: unknown): Preferences | null {
  ...
  return {
    ...
    accent: isAccentChoice(record.accent) ? record.accent : DEFAULT_PREFERENCES.accent,
  };
}
