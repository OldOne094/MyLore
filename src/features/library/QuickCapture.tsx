              ...
              {nodesQuery.isPending ? (
                ...
                <div className="flex flex-col gap-4">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-md border border-accent bg-accent-soft px-4 py-2 text-sm font-medium text-accent transition-[color,background-color,border-color,scale] duration-150 ease-out hover:bg-accent hover:text-bg-surface active:scale-[0.96] disabled:pointer-events-none disabled:opacity-60"
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {amounts.map((count) => (
                        <button
                          ...
                          className="inline-flex h-9 min-w-12 items-center justify-center rounded-md border border-border-subtle px-3 text-sm text-text-primary transition-[color,border-color,scale] duration-150 ease-out hover:border-accent hover:text-accent active:scale-[0.96] disabled:pointer-events-none disabled:opacity-60"
                        >
